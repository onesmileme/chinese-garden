...
import type { ChildDifficulty, Corpus, DailyPlanInput } from "@cc/domain";
...
export const demoCorpus: Corpus = {
  ...
  // 成语取难度 1 的闭合接龙组（组内每条成语都有后继），任意路由到 IDIOM_CHAIN 均可生成。
...
export const assessmentLevelKpIds = [
  asKnowledgePointId("cy-yixinyiyi"),
  asKnowledgePointId("sc-jingyesi"),
  asKnowledgePointId("sc-chunxiao"),
] as const;
...
export const dailyPlanInput: DailyPlanInput = {
  dueReviewKpIds: [
    ...
    asKnowledgePointId("cy-fayangguangda"),
  ],
  recentWeakKpIds: [
    asKnowledgePointId("sc-jingyesi"),
    asKnowledgePointId("sc-yonge"),
  ],
  previousKpId: asKnowledgePointId("sc-yonge"),
  newKpId: asKnowledgePointId("sc-jingyesi"),
  mixedReviewKpIds: [
    asKnowledgePointId("cy-yixinyiyi"),
    asKnowledgePointId("sc-yonge"),
  ],
